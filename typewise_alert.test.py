...
class TypewiseTest(unittest.TestCase):
  def test_infers_breach_as_per_limits(self):
    ...
    self.assertTrue(typewise_alert.check_and_alert('TO_EMAIL', 'MED_ACTIVE_COOLING', 40) == 'NORMAL')
    ...
    self.assertTrue(typewise_alert.check_and_alert('TO_EMAIL', 'HI_ACTIVE_COOLING', 45) == 'NORMAL')
    self.assertFalse(typewise_alert.check_and_alert('TO_EMAIL', 'HI_ACTIVE_COOLING', 40) == 'TOO_LOW')
    self.assertTrue(typewise_alert.check_and_alert('TO_EMAIL', 'HI_ACTIVE_COOLING', 50) == 'TOO_HIGH')
    self.assertTrue(typewise_alert.check_and_alert('TO_CONTROLLER', 'PASSIVE_COOLING', -1) == 'TOO_LOW')
