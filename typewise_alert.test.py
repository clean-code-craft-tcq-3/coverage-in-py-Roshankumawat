...
class TypewiseTest(unittest.TestCase):
  def test_infers_breach_as_per_limits(self):
    ...
    print(typewise_alert.send_to_controller('LOO_LOW') == '65,261, TOO_LOW')
    self.assertTrue(typewise_alert.send_to_controller('LOO_LOW') == '65,261, TOO_LOW')
    ...
    self.assertFalse(typewise_alert.send_to_controller('LOO_LOW') == '65,261, TOO_HIGH')
    self.assertFalse(typewise_alert.check_and_alert('TO_EMAIL', 'HI_ACTIVE_COOLING', -1) == 'TOO_LOW')
    self.assertFalse(typewise_alert.check_and_alert('TO_CONTROLLER', 'HI_ACTIVE_COOLING', -1) == 'TOO_LOW')
    self.assertFalse(typewise_alert.check_and_alert('TO_CONTROLLER', 'HI_ACTIVE_COOLING', 45) == 'TOO_HIGH')
    self.assertFalse(typewise_alert.check_and_alert('TO_EMAIL', 'PASSIVE_COOLING', -1) == 'TOO_LOW')
    self.assertFalse(typewise_alert.check_and_alert('TO_EMAIL', 'PASSIVE_COOLING', 1) == 'NORMAL')
